...
async def get(url: str, *args, **kwargs):
    async with tede.get(url, *args, **kwargs) as resp:
        try:
...
async def head(url: str, *args, **kwargs):
    async with tede.head(url, *args, **kwargs) as resp:
        try:
            data = await resp.json()
        except Exception:
            data = await resp.text()
...
async def post(url: str, *args, **kwargs):
    async with tede.post(url, *args, **kwargs) as resp:
        try:
            data = await resp.json()
        except Exception:
            data = await resp.text()
...
async def resp_get(url: str, *args, **kwargs):
    return await tede.get(url, *args, **kwargs)


async def resp_post(url: str, *args, **kwargs):
    return await tede.post(url, *args, **kwargs)
