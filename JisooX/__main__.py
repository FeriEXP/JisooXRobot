...
def send_start(bot, update):
    ...
    keyboard += [[InlineKeyboardButton(text="[► Anos ◄]", callback_data="t.me/AnosVoldigoadBot"),InlineKeyboardButton(text="[► Add Me ◄]",url="t.me/{}?startgroup=true".format(bot.username))]]
