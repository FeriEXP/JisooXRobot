...
def send_start(bot, update):
    ...
    keyboard += [[InlineKeyboardButton(text="[► Anos ◄]", callback_data="https://t.me/anosvoldigoadbot"),InlineKeyboardButton(text="⚜️Add Me⚜️",url="t.me/{}?startgroup=true".format(bot.username))]]
