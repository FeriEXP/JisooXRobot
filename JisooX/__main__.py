...
def send_start(bot, update):
    ...
    keyboard += [[InlineKeyboardButton(text="[► Inline ◄]", callback_data=", switch_inline_query_current_chat=""),InlineKeyboardButton(text="⚜️Add Me⚜️",url="t.me/{}?startgroup=true".format(bot.username))]]
